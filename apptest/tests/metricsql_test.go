...
import (
	...
	"github.com/zzylol/VictoriaMetrics-cluster/apptest"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/decimal"
	pb "github.com/zzylol/VictoriaMetrics-cluster/lib/prompbmarshal"
...
func testInstantQueryDoesNotReturnStaleNaNs(t *testing.T, sut apptest.PrometheusWriteQuerier) {
	...
	// while it must not.
	// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/5806
