...
- [operator](https://docs.victoriametrics.com/operator/): operator trims spaces from `Secret` and `Configmap` values by default. This behaviour could be changed with flag `disableSecretKeySpaceTrim`. Related [issue](https://github.com/zzylol/VictoriaMetrics-cluster/issues/6986).
...
- Update VictoriaMetrics image tags to [v1.101.0](https://github.com/zzylol/VictoriaMetrics-cluster/releases/tag/v1.101.0).
...
- Update VictoriaMetrics image tags to [v1.100.1](https://github.com/zzylol/VictoriaMetrics-cluster/releases/tag/v1.100.1).
...
- scrape CRDs: deprecated option `relabel_debug` and  `metric_relabel_debug`, they were deprecated since [v1.85.0](https://github.com/zzylol/VictoriaMetrics-cluster/releases/tag/v1.85.0).
...
- Update VictoriaMetrics image tags to [v1.99.0](https://github.com/zzylol/VictoriaMetrics-cluster/releases/tag/v1.99.0).
...
- Update VictoriaMetrics image tags to [v1.98.0](https://github.com/zzylol/VictoriaMetrics-cluster/releases/tag/v1.98.0).
...
- update VictoriaMetrics image tags to [v1.97.1](https://github.com/zzylol/VictoriaMetrics-cluster/releases/tag/v1.97.1).
...
- update VictoriaMetrics image tags to [v1.95.1](https://github.com/zzylol/VictoriaMetrics-cluster/releases/tag/v1.95.1).
...
- [vmoperator](https://docs.victoriametrics.com/operator/): bump default version of VictoriaMetrics components to [1.93.4](https://github.com/zzylol/VictoriaMetrics-cluster/releases/tag/v1.93.4).
...
- bump default version of Victoria Metrics components to [v1.93.3](https://github.com/zzylol/VictoriaMetrics-cluster/releases/tag/v1.93.3)
...
- [vmagent](https://docs.victoriametrics.com/operator/api#vmagent)/[vmsingle](https://docs.victoriametrics.com/operator/api#vmsingle): adapt new features in streaming aggregation:
  - support `streamAggr.dropInput`, see [this issue](https://github.com/zzylol/VictoriaMetrics-cluster/issues/4243) for details;
  - support list for `match` parameter, see [this issue](https://github.com/zzylol/VictoriaMetrics-cluster/issues/4635) for details;
  - support `staleness_interval`, see [this issue](https://github.com/zzylol/VictoriaMetrics-cluster/issues/4667) for details.
...
- vmagent: fixes incorrect usage of remoteWriteSettings  <https://github.com/zzylol/VictoriaMetrics-cluster/issues/2946>
...
- removes liveness probe from vmstorage and `VMSingle` <https://github.com/zzylol/VictoriaMetrics-cluster/issues/1158>
...
- `VMRule` support `concurrency` for group execution, see detail at vmalert docs  <https://github.com/zzylol/VictoriaMetrics-cluster/tree/master/app/vmalert#groups>.
...
- Fixes `VMAgent` start-up error <https://github.com/zzylol/VictoriaMetrics-cluster/issues/879>
