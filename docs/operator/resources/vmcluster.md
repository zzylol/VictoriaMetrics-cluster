...
For `VMCluster` you can specify tag name from [releases](https://github.com/zzylol/VictoriaMetrics-cluster/releases) and repository setting per cluster object:
