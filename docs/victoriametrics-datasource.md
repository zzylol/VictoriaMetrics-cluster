---
weight: 38
editLink: https://github.com/zzylol/VictoriaMetrics-cluster-datasource/blob/main/README.md
...
The [VictoriaMetrics datasource plugin](https://github.com/zzylol/VictoriaMetrics-cluster-datasource) 
...
[VictoriaMetrics repo](https://github.com/zzylol/VictoriaMetrics-cluster) provides a complete [docker-compose](https://github.com/zzylol/VictoriaMetrics-cluster/tree/master/deployment/docker#docker-compose-environment-for-victoriametrics) environment to spin-up all required components via Docker.

To begin, clone [VictoriaMetrics](https://github.com/zzylol/VictoriaMetrics-cluster) repository and follow steps described in the [README](https://github.com/zzylol/VictoriaMetrics-cluster/tree/master/deployment/docker#docker-compose-environment-for-victoriametrics).
   ...
   ```yaml
     ...
     services:
       grafana:
         ...
         environment:
         - GF_INSTALL_PLUGINS=https://github.com/zzylol/VictoriaMetrics-cluster-datasource/releases/download/v0.10.3/victoriametrics-datasource-v0.10.3.zip;victoriametrics-datasource
...
``` yaml
plugins:
  - https://github.com/zzylol/VictoriaMetrics-cluster-datasource/releases/download/v0.10.3/victoriametrics-datasource-v0.10.3.zip;victoriametrics-datasource
```
  ...
  - name: "load-vm-ds-plugin"
    ...
    args:
     ...
     - |
       ...
       curl -L https://github.com/zzylol/VictoriaMetrics-cluster-datasource/releases/download/$ver/victoriametrics-datasource-$ver.tar.gz -o /var/lib/grafana/plugins/vm-plugin.tar.gz
...
Grafana doesn't allow forwarding Alert requests to alerting API /api/v1/rules for plugins which are not of Prometheus or Loki type. See more details [here](https://github.com/zzylol/VictoriaMetrics-cluster-datasource/issues/59#issuecomment-1541456768).

## License

This project is licensed under
the [AGPL-3.0-only](https://github.com/zzylol/VictoriaMetrics-cluster-datasource/blob/main/LICENSE).
