...
Pre-built binaries for VictoriaLogs are available at the [releases](https://github.com/zzylol/VictoriaMetrics-cluster/releases/) page.
...
```sh
curl -L -O https://github.com/zzylol/VictoriaMetrics-cluster/releases/download/v1.3.2-victorialogs/victoria-logs-linux-amd64-v1.3.2-victorialogs.tar.gz
...
- [Filebeat demo](https://github.com/zzylol/VictoriaMetrics-cluster/tree/master/deployment/docker/victorialogs/filebeat)
- [Fluentbit demo](https://github.com/zzylol/VictoriaMetrics-cluster/tree/master/deployment/docker/victorialogs/fluentbit)
- [Logstash demo](https://github.com/zzylol/VictoriaMetrics-cluster/tree/master/deployment/docker/victorialogs/logstash)
- [Vector demo](https://github.com/zzylol/VictoriaMetrics-cluster/tree/master/deployment/docker/victorialogs/vector)
- [Promtail demo](https://github.com/zzylol/VictoriaMetrics-cluster/tree/master/deployment/docker/victorialogs/promtail)
