...
Every LTS line receives bugfixes and [security fixes](https://github.com/zzylol/VictoriaMetrics-cluster/blob/master/SECURITY.md) for 12 months after
...
All the bugfixes and security fixes, which are included in LTS releases, are also available in [the latest release](https://github.com/zzylol/VictoriaMetrics-cluster/releases/latest),
...
- v1.102.x - the latest one is [v1.102.9 LTS release](https://github.com/zzylol/VictoriaMetrics-cluster/releases/tag/v1.102.9)
- v1.97.x - the latest one is [v1.97.14 LTS release](https://github.com/zzylol/VictoriaMetrics-cluster/releases/tag/v1.97.14)
