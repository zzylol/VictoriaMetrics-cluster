...
It is recommended to use the [single-node version](https://github.com/zzylol/VictoriaMetrics-cluster) instead of the cluster version
...
from [the releases page](https://github.com/zzylol/VictoriaMetrics-cluster/releases/latest).
...
- Supports all the features of the [single-node version](https://github.com/zzylol/VictoriaMetrics-cluster).
...
Compiled binaries for the cluster version are available in the `assets` section of the [releases page](https://github.com/zzylol/VictoriaMetrics-cluster/releases/latest).
...
The source code for the cluster version is available in the [cluster branch](https://github.com/zzylol/VictoriaMetrics-cluster/tree/cluster).
...
1. Run `make` from [the repository root](https://github.com/zzylol/VictoriaMetrics-cluster). It should build `vmstorage`, `vmselect`
...
`<PKG_TAG>` is auto-generated image tag, which depends on source code in [the repository](https://github.com/zzylol/VictoriaMetrics-cluster).
...
- [An example docker-compose config for VictoriaMetrics cluster](https://github.com/zzylol/VictoriaMetrics-cluster/blob/master/deployment/docker/docker-compose-cluster.yml)
...
[Enterprise version of VictoriaMetrics](https://docs.victoriametrics.com/enterprise/) can be downloaded and evaluated for free from [the releases page](https://github.com/zzylol/VictoriaMetrics-cluster/releases/latest).
See how to request a free trial license [here](https://victoriametrics.com/products/enterprise/trial/).
...
It is recommended setting up alerts in [vmalert](https://docs.victoriametrics.com/vmalert/) or in Prometheus from [this list](https://github.com/zzylol/VictoriaMetrics-cluster/tree/master/deployment/docker#alerts).
...
Enterprise binaries can be downloaded and evaluated for free from [the releases page](https://github.com/zzylol/VictoriaMetrics-cluster/releases/latest).
See how to request a free trial license [here](https://victoriametrics.com/products/enterprise/trial/).
...
Report bugs and propose new features [here](https://github.com/zzylol/VictoriaMetrics-cluster/issues).
...
```
  ...
  -vmui.customDashboardsPath string
     Optional path to vmui dashboards. See https://github.com/zzylol/VictoriaMetrics-cluster/tree/master/app/vmui/packages/vmui/public/dashboards
