...
* `Metrics` has been extracted from [VictoriaMetrics](https://github.com/zzylol/VictoriaMetrics-cluster) sources.
...
because `vmrange` buckets don't include counters for the previous ranges. [VictoriaMetrics](https://github.com/zzylol/VictoriaMetrics-cluster) provides `prometheus_buckets`
