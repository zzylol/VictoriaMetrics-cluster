...
import (
	...
	"github.com/zzylol/VictoriaMetrics-cluster/lib/backup/actions"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/backup/common"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/backup/fslocal"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/backup/fsnil"
	...
	"github.com/zzylol/VictoriaMetrics-cluster/lib/snapshot"
...
func main() {
	...
	// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/2055
	deleteSnapshot := func() {}
