...
import (
	...
	"github.com/zzylol/VictoriaMetrics-cluster/app/vmalert/rule"
	"github.com/zzylol/VictoriaMetrics-cluster/app/vmalert/tpl"
...
func (rh *requestHandler) groups(rf rulesFilter) []apiGroup {
	...
	for _, group := range rh.m.groups {
		...
		// https://github.com/zzylol/VictoriaMetrics-cluster/issues/4221
