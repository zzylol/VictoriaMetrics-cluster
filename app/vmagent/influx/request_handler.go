...
import (
	...
	parser "github.com/zzylol/VictoriaMetrics-cluster/lib/protoparser/influx"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/protoparser/influx/stream"
...
func insertRows(at *auth.Token, db string, rows []parser.Row, extraLabels []prompbmarshal.Label) error {
	...
	for i := range rows {
		...
		// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/1139
