...
import (
	...
	"github.com/zzylol/VictoriaMetrics-cluster/app/vmselect/clusternative"
	"github.com/zzylol/VictoriaMetrics-cluster/app/vmselect/graphite"
	"github.com/zzylol/VictoriaMetrics-cluster/app/vmselect/netstorage"
	"github.com/zzylol/VictoriaMetrics-cluster/app/vmselect/prometheus"
...
var (
	...
	maxQueueDuration = flag.Duration("search.maxQueueDuration", 36000*time.Second, "The maximum time the request waits for execution when -search.maxConcurrentRequests "+
...
`)
	...
	case "prometheus/api/v1/status/buildinfo":
		...
		// see this issue for more info: https://github.com/zzylol/VictoriaMetrics-cluster/issues/5370
...
func proxyVMAlertRequests(w http.ResponseWriter, r *http.Request, path string) {
	defer func() {
		...
		if err == nil || err == http.ErrAbortHandler {
			...
			// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/1353
			return
		}
