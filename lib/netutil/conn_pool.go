...
type ConnPool struct {
	...
	// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/2552
	...
	// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/711#issuecomment-1160363187
	lastDialError error
}
...
func (cp *ConnPool) getConnSlow() (*handshake.BufferedConn, error) {
	...
	// This should help https://github.com/zzylol/VictoriaMetrics-cluster/issues/2552
...
func (cp *ConnPool) closeIdleConns() {
	...
	// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/2508
