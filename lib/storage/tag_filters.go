...
import (
	...
	"github.com/zzylol/VictoriaMetrics-cluster/lib/lrucache"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/memory"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/regexutil"
...
func convertToCompositeTagFilters(tfs *TagFilters) []*TagFilters {
	...
	// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/2238
...
func (tfs *TagFilters) Add(key, value []byte, isNegative, isRegexp bool) error {
	...
	if tf.isNegative && tf.isEmptyMatch {
		...
		// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/546 for details.
