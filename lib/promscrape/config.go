...
import (
	...
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/azure"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/consul"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/consulagent"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/digitalocean"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/dns"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/docker"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/dockerswarm"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/ec2"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/eureka"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/gce"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/hetzner"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/http"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/kubernetes"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/kuma"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/nomad"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/openstack"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/ovhcloud"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/puppetdb"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/vultr"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promscrape/discovery/yandexcloud"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/promutils"
	"github.com/zzylol/VictoriaMetrics-cluster/lib/proxy"
...
func mustInitClusterMemberID() {
	...
	// https://github.com/zzylol/VictoriaMetrics-cluster/issues/2359
...
func (cfg *Config) mustRestart(prevCfg *Config) bool {
	...
	// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/2884
...
type ScrapeConfig struct {
	...
	// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/4697#issuecomment-1654614799 for details.
...
func getScrapeWorkConfig(sc *ScrapeConfig, baseDir string, globalCfg *GlobalConfig) (*scrapeWorkConfig, error) {
	...
	if scrapeTimeout > scrapeInterval {
		...
		// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/1281#issuecomment-840538907
...
func (swc *scrapeWorkConfig) getScrapeWork(target string, extraLabels, metaLabels *promutils.Labels) (*ScrapeWork, error) {
	...
	// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/1687#issuecomment-940629495
	if *clusterMembersCount > 1 {
	...
	// See https://github.com/zzylol/VictoriaMetrics-cluster/issues/825 for details.
